...
class LikeModal extends Modal {
    ...
    setCategory(selected) {
        let like = (selected.closest('tr').querySelector('.type').innerText == "L") ? 'like' : 'unlike';
        let userCode = selected.closest('tr').querySelector('.type').querySelector('.user_code').value;
        let userGubun = selected.closest('tr').querySelector('.type').querySelector('.user_gubun').value;
        ...
        setData(like, category, userCode, userGubun);
    }
...
class FileUploader {
    ...
    addFile(event) {
        ...
        console.log('file', file, fileValidation);
